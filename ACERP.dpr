...
uses
  ...
  acerp.view.components.interfaces2 in 'src\view\componentes\acerp.view.components.interfaces2.pas',
  acerp.core.entities.empresa in 'src\core\entities\acerp.core.entities.empresa.pas',
  acerp.view.componentes.cardsgraficos2 in 'src\view\componentes\cardsgraficos\acerp.view.componentes.cardsgraficos2.pas' {ComponentCardGraficos2},
  Router4D in 'modules\router4delphi\src\Router4D.pas',
  Router4D.Props in 'modules\router4delphi\src\Router4D.Props.pas',
  Router4D.Render in 'modules\router4delphi\src\Router4D.Render.pas',
  Router4D.Sidebar in 'modules\router4delphi\src\Router4D.Sidebar.pas',
  Router4D.Switch in 'modules\router4delphi\src\Router4D.Switch.pas',
  Router4D.Utils in 'modules\router4delphi\src\Router4D.Utils.pas';
